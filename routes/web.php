...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('discount')->group(function () {
            ...
            Route::get('/amazing-sale/edit/{amazing}', [DiscountController::class, 'amazingSaleEdit'])->name('admin.market.discount.amazingSale.edit');
            Route::put('/amazing-sale/update/{amazing}', [DiscountController::class, 'amazingSaleUpdate'])->name('admin.market.discount.amazingSale.update');
            Route::delete('/amazing-sale/destroy/{amazing}', [DiscountController::class, 'amazingSaleDestroy'])->name('admin.market.discount.amazingSale.destroy');
        });
    ...
    Route::prefix('user')->namespace('User')->group(function () {
        ...
        Route::prefix('role')->group(function () {
            ...
            Route::get('permissionForm/{role}', [RoleController::class, 'permissionForm'])->name('admin.user.role.permissionForm');
            Route::put('permissionUpdate/{role}', [RoleController::class, 'permissionUpdate'])->name('admin.user.role.permissionForm.update');
        });
    ...
    Route::prefix('notify')->namespace('Notify')->group(function () {
        ...
        Route::prefix('email')->group(function () {
            ...
            Route::get('/status/{email}', [EmailController::class, 'status'])->name('admin.content.email.status');
        });

        Route::prefix('email_file')->group(function () {
        ...
        Route::prefix('sms')->group(function () {
            ...
            Route::get('/status/{sms}', [SMSController::class, 'status'])->name('admin.content.sms.status');
        });
    });
