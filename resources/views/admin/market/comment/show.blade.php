            ...
            <section class="main-body-container">
                ...
                <section class="card mb-3">
                    ...
                    <section class="card-body">
                        <h5 class="card-title">اسم محصول : {{ $comment->product->name }} / کد پست:{{ $comment->product->id }}
                        </h5>
                ...
                <section class="m-3 ">
                    ...
                    @foreach ($answers as $answer)
                        <div class="d-flex m-4 border border-dark justify-content-between">
                            ...
                            <div class="m-4">
                                @if ($answer->status == 0)
                                    <a href="{{ route('admin.market.comment.answerStatus', $answer->id) }}"
                                ...
                                <form action="{{ route('admin.market.comment.destroy', $answer->id) }}"
